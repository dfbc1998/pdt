// src/app/features/proposals/proposal-edit/proposal-edit.component.ts
...
@Component({
  ...
  template: `
    <app-header title="Editar Propuesta"></app-header>
    <ion-content class="ion-padding">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Editar Propuesta</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          <p>Formulario de edición de propuesta - En desarrollo...</p>
        </ion-card-content>
      </ion-card>
    </ion-content>
  `
