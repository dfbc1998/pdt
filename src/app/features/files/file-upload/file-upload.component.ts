// src/app/features/files/file-upload/file-upload.component.ts
...
@Component({
  ...
  template: `
    <app-header title="Subir Archivos"></app-header>
    <ion-content class="ion-padding">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Subir Archivos</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          <p>Interfaz para subir archivos - En desarrollo...</p>
        </ion-card-content>
      </ion-card>
    </ion-content>
  `
